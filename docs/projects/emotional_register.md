...
- [x] **Persona spec → prompt** — the fuller canonical voice (§ The persona spec) lives in `PERSONA_GUIDE` (`src/services/evaluatorPrompts.ts`), appended to all six prompt strings. (PR #30.)
