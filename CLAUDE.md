...
| `docs/plan-archive.md`                         | You need the milestone-level record of a **fully-shipped** phase (0–5). Archived off `plan.md` on 2026-07-10 for readability; not scanned by the routing-annotation contract. The live plan keeps phases 6+.                                                                                                                                                          |
