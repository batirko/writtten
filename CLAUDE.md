...
`docs/plan.md` is the source of truth for the current phase — check its "Current phase" marker (line 7) before adding functionality. **Public launch happened 2026-07-10** — writtten.com is live, the repo is public, and outreach has started. As of the 2026-07-10 plan re-cut the current phase is **Phase 7 — "Post-launch polish & credibility"**: a bounded list of what a public visitor/reader now touches (hero visual, in-app OSS link, legal/privacy pages, branch protection, the live-check release gate, strong-tier eval reliability, and the two prod-visible doc-level prompt defects OBS-034/OBS-035). **Phase 8 — "Validation & signal quality"** is next (V1 corpus study first — it unblocks the precision-floor recalibration, the free-vs-paid decision, and most strategic open questions), **Phase 9 — "Later / optional (post-traction)"** holds parked work (don't pre-build it), and concept-stage items live in _Discovered / unscheduled_. Phases 1–6 are shipped/closed (Phase 6 — experience & signal quality — closed 2026-07-10; full records in `docs/plan-archive.md`). Don't trust this paragraph over `docs/plan.md` if they ever drift — update the plan there, then mirror the headline here.
