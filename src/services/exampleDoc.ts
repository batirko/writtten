 ...
 *   - tension: the panel "stays quiet and never interrupts" (Non-goals) vs.
 *     measuring "the share of surfaced observations that authors act on"
 *     (Success metrics) — competing goals (stay unobtrusive vs. drive
 *     engagement), not a logical impossibility.
 ...
 *     vague, unmeasurable criterion (the adoption metrics beside it are
 *     concrete, so they stay quiet).
 *   - missing_topic: no go-to-market / adoption path — a launch date and a
 *     500-active-docs target, but nothing on how PMs discover or start using it.
 *
...
<h2>Timeline</h2>
<p>We are committing to a public launch in Q2 2026, and engineering is confident it can hit that date.</p>
<h2>Success metrics</h2>
<p>We will measure adoption by weekly active documents, targeting five hundred within the first quarter, and by the share of surfaced observations that authors act on. We will also track whether the observations feel trustworthy to authors. The public launch is firmly set for Q3 2026, giving us a full quarter of beta feedback before general availability.</p>
<h2>Non-goals</h2>
<p>The assistant will not generate or rewrite document text in any phase; it stays quiet and never interrupts the writer. It observes; the author decides.</p>`;
